<%-- 
    ...
    Created on : Nov 7, 2023, 1:06:54 AM
    Author     : Admin
--%>
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.listC}" var="c">
                            <tr>
                                ...
                                <td>
                                    <a href="loadcat?cid=${c.cid}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deletecategory?cid=${c.cid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
